...
public interface ApplicationExternalCallMapper {
    
    ApplicationExternalCallDTO toDTO(ApplicationExternalCall entity);
    
    ApplicationExternalCall toEntity(ApplicationExternalCallDTO dto);
}
