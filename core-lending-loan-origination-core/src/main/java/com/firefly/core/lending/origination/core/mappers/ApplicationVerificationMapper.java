...
public interface ApplicationVerificationMapper {

    ApplicationVerificationDTO toDTO(ApplicationVerification entity);

    ApplicationVerification toEntity(ApplicationVerificationDTO dto);
}
