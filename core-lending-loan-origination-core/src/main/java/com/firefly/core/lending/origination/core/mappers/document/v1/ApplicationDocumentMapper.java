...
public interface ApplicationDocumentMapper {
    ...
    @Mapping(target = "documentType", expression = "java(dto.getDocumentTypeId() != null ? com.firefly.core.lending.origination.interfaces.enums.document.v1.DocumentTypeEnum.values()[dto.getDocumentTypeId().intValue()] : null)")
