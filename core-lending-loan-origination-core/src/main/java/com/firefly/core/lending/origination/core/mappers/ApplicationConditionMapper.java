...
public interface ApplicationConditionMapper {
    
    ApplicationConditionDTO toDTO(ApplicationCondition entity);
    
    ApplicationCondition toEntity(ApplicationConditionDTO dto);
}
