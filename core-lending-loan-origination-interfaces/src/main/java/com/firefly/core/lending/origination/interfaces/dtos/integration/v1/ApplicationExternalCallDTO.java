...
package com.firefly.core.lending.origination.interfaces.dtos.integration.v1;
...
@NoArgsConstructor
@AllArgsConstructor
public class ApplicationExternalCallDTO {
    ...
    @Size(max = 50, message = "Call type cannot exceed 50 characters")
